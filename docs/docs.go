...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "models.OutboundMessage": {
            ...
            "properties": {
                "conversation_id": {
                    "description": "for \"newMessage\", \"seenMessage\", \"messageHistory\"",
                    "type": "integer"
                },
                "conversations": {
                    "description": "For \"conversationList\"",
                    "type": "array",
                    "items": {
                ...
                "id": {
                    "description": "For \"yourID\"",
                    "type": "string"
                },
                "message": {
                    "description": "For \"newMessage\"",
                    "allOf": [
                        {
                ...
                "messages": {
                    "description": "For \"messageHistory\"",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.Message"
                    }
